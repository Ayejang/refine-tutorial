...
import { useMany, GetManyResponse, useDelete } from "@pankod/refine-core";
...
// 변수는 useMemo, 함수는 useCallback 을 이용해서 캐싱을 할 수 있다
// 컴포넌트는 하나가 바뀌면 첨부터 다 생성할 수 있기때문에 모양이 똑같으면 예전에 만든걸 사용할 수 있도록 한다
// 퍼포먼스 향상을 위해 useCallback을 이용해 재랜더링을 하도록 한다
